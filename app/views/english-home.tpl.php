<div class="container container--about row mx-auto justify-content-center">
    <div class="row justify-content-center">
        ...
        <p class="alert col-lg-10"> <i class="em em-loudspeaker" aria-role="presentation" aria-label="PUBLIC ADDRESS LOUDSPEAKER"></i> Aurélie <strong>is looking for a programmers dreamteam</strong> around Paris for an <strong>apprenticeship</strong> starting early September or October 2020 (<em>between 12 and 36 months</em>) in order to prepare <em>a computer science Bachelor, Software and Web programming path</em> then a Master's degree.</p>
