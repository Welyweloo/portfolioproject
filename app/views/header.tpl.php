...
<html lang="en">
    ...
    <body>
        <header>
            ...
            <div class="image m-5">
                <img class="rounded-circle img-thumbnail mx-auto d-block" src="/images/aurelie.png" alt="Photo d'Aurélie" width="200" height="205"/>
            </div>
            ...
            <ul class="nav justify-content-center m-2">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/docs/CV-AurelieAnglio-2021.pdf" target="_blank">CV</a>
                </li>    
                <li class="nav-item">
